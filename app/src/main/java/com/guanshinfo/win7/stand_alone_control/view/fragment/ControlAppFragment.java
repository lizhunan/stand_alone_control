...
public class ControlAppFragment extends Fragment implements IGetData, View.OnClickListener, AppListAdapter.OnItemLongClickListener, AppListAdapter.OnItemClickListener, ActionMode.Callback {

    private OnFragmentInteractionListener mListener;

    public static ControlAppFragment INSTANCE;
    ...
    public ControlAppFragment() {

    }

    public static ControlAppFragment newInstance() {
        if (INSTANCE == null) {
            INSTANCE = new ControlAppFragment();
        }
        return INSTANCE;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_control_app, container, false);
        initView(view);
        return view;
    }
    ...
    public void showSuccess(List<AppInfo> appInfos) {
        ...
        data = appInfos;
        appListAdapter = new AppListAdapter(data, 2);
            ...
            case R.id.control_fab:
                try {
                    ...
                    for (AppInfo val : valueSet) {
                        BaseApplication.mDPM.setApplicationHidden(BaseApplication.mComponentName, val.getPkgName(), false);
                        DatabaseUtils.deletePkg(db, val.getPkgName());
                    }
                    refreshUI();
                    actionMode.finish();
                } catch (Exception e) {
