...
import com.guanshinfo.win7.stand_alone_control.ui.indexui.QuickIndexView;
...
public class SystemAppFragment extends Fragment implements IGetData, View.OnClickListener, AppListAdapter.OnItemLongClickListener, AppListAdapter.OnItemClickListener, ActionMode.Callback {

    private OnFragmentInteractionListener mListener;

    public static SystemAppFragment INSTANCE;
    ...
    public static SystemAppFragment newInstance() {
        if (INSTANCE == null) {
            INSTANCE = new SystemAppFragment();
        }
        return INSTANCE;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_system_app, container, false);
        initView(view);
        return view;
    }
    ...
    public void showSuccess(List<AppInfo> appInfos) {
        ...
        data = appInfos;
        appListAdapter = new AppListAdapter(data, 1);
